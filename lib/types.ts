...
export type SiteSettings = { companyName:string;adminName:string;phone:string;whatsapp:string;whatsappMessage:string;email:string;address:string;facebook:string;instagram:string;tiktok:string;twitter:string;linkedin:string;heroTitle:string;heroAccent:string;heroText:string };
